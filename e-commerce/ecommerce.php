...
<head>
    ...
    <title>Farhan e-commerce Website</title>
    <link rel="stylesheet" href="index.css">
    <script src="https://kit.fontawesome.com/79b26a05ce.js" crossorigin="anonymous"></script>
    <!-- <script src="./index.js"></script> -->
</head>
<body>
    <section class=" top-txt ">
        <div class="head container ">
            <div class="head-txt" style="display: flex; gap: 14em;">
                <p>Free shipping Above 150$, 30-day return or refund guarantee Time</p>
                <p class="time"></p>
            </div>
    ...
    <nav class="navbar">
        <div class="navbar-container">
           ...
           <!-- //////////////////////////////////////////////////////// -->
          <div style="display: flex; align-items: center; justify-content: space-between; border: 1px solid black; padding:4px
           ; border-radius: 5px;">
            <input type="text" placeholder="search here"
            style="width:35rem; padding: 7px; border: transparent; outline: none;" 
        ...
        <form action="https://formspree.io/f/xzbowpjq" method="POST">
            <div class="form">
                <div class="form-txt">
                    ...
                    <h3>India</h3>
                    <p>HW95+C9C, Deshmukhi<br>411014</p>
                </div>
